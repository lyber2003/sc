...
class InstallController extends Base
{
    ...
    /**
     * @Route("/apps/{crudModule:[A-Za-z]+}/model/{crudGrid:[A-Za-z]+}/Grid.js", methods={"GET"}, name="crud-grid")
     */
    public function modelGridAction($module, $grid)
    {
        $this->_grid($module, $grid);
        echo file_get_contents(PUBLIC_PATH."/extjs/apps/".ucfirst($module)."/model/".ucfirst($grid)."/Grid.js");
    }

    /**
     * @Route("/apps/{crudModule:[A-Za-z]+}/model/{crudForm:[A-Za-z]+}/Form.js", methods={"GET"}, name="crud-form")
     */
    public function modelFormAction($module, $form)
    {
        $this->_form($module, $form);
        echo file_get_contents(PUBLIC_PATH."/extjs/apps/".ucfirst($module)."/model/".ucfirst($form)."/Form.js");
    }

    /**
     * @Route("/apps/{crudModule:[A-Za-z]+}/store/{crudGrid:[A-Za-z]+}/Grid.js", methods={"GET"}, name="crud-grid")
     */
    public function storeGridAction($module, $grid)
    {
        $this->_grid($module, $grid);
        echo file_get_contents(PUBLIC_PATH."/extjs/apps/".ucfirst($module)."/store/".ucfirst($grid)."/Grid.js");
    }

    /**
     * @Route("/apps/{crudModule:[A-Za-z]+}/store/{crudForm:[A-Za-z]+}/Form.js", methods={"GET"}, name="crud-form")
     */
    public function storeFormAction($module, $form)
    {
        $this->_form($module, $form);
        echo file_get_contents(PUBLIC_PATH."/extjs/apps/".ucfirst($module)."/store/".ucfirst($form)."/Form.js");
    }
